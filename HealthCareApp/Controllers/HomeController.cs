...
namespace HealthCareApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            DonorAppStatusList modeldonorstatu=new DonorAppStatusList();
            modeldonorstatu.BuPlatformdanBulundu = 5;
            modeldonorstatu.Bekliyor = 15;
            modeldonorstatu.Iptal = 3;
            model.DonorAppStatus = modeldonorstatu;
            return View(model);
        }
        [HttpPost]
